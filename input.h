...
#define BUTTON_UP_R		0x00010000l	// 方向キー上(.IY<0)
#define BUTTON_DOWN_R	0x00020000l	// 方向キー下(.IY>0)
#define BUTTON_LEFT_R	0x00040000l	// 方向キー左(.IX<0)
#define BUTTON_RIGHT_R	0x00080000l	// 方向キー右(.IX>0)
