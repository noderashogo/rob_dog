...
SOUNDPARAM g_aParam[SOUND_LABEL_MAX] =
{
	...
	{ (char*)"data/BGM/MusMus125.wav", -1 },	// BGM3
	{ (char*)"data/BGM/MusMus146.wav", -1 },	// BGM4
	...
	{ (char*)"data/SE/8bit_shoot1.wav", 0 },	// 弾発射音
	{ (char*)"data/SE/se_damage3.wav", 0 },		// ヒット音
...
void SetMasterVolume(float volume)
{
	...
	{
		if (g_apSourceVoice[i])
		{
			g_apSourceVoice[i]->SetVolume(volume);
		}
	}
}
